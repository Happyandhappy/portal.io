...
<header>
	...
	<div class="nav" style="background:url('../images/curve_bottom8.png') no-repeat; background-size: contain;">
		<div class="container">
			<div class="row">
					...
					<nav class="menu">
                        ...
                        <div class="dropdown">
                            <button class="dropbtn">Support</button>
                                <div class="dropdown-content">
                                    <a class="nav-link active" href="<?php echo base_url(); ?>?/Public_www/knowledge_base">&emsp;Knowledge Base</a>
				...
				<div class="col-md-12 col-sm-12 col-lg-5" style="height:47px";>
					<div class="account tb" style="height:47px;">
				            <div class="right_title das_title" style="height:47px">
								<button>Manage Clients &nbsp; <i class="fa fa-angle-double-right"></i></button>
							</div>                        
						<button class="new_acc tb-cell" style="position: 500px, 0px;">Logout &nbsp; <i class="fa fa-angle-double-right"></i>
					</button>
					</div>
				</div>
			</div>
