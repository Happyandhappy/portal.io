			...
			<div class="row">
				<div class="col-md-8 left after_right">
					...
					<div class="menu-icon tb">
						...
						<a href="<?php echo base_url(); ?>?/Private_www/mng_accountant"><span class="tb-cell header-menu-left">Accountant Management</span></a>
						| 
						<a href="<?php echo base_url(); ?>?/Private_www/mng_client"><span class="tb-cell header-menu-right">Client Management</span></a>
					</div>
					<div class="socials">
						<ul>
